...
import about from '../video/pexels-video-4170249-primary-w1280-h720.mp4'
                ...
                <div class="row">
                    <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                        <div class="inner-column">
                            <div class="sec-title">
                                <p class="title">About Us <span style={{ color: "#3B38EB", fontSize: '3em', fontFamily: 'monospace' }}>!</span></p>
                                <h2>We are Creative Tech Enthusiast working since 2024</h2>
                            </div>
                            <div class="text">I am Kazim Naqvi works at Css3 Transition since last 3 years. We are here to provide touch notch solution for your website or web application that helps you to make your website look attractive & efficient in handling by creating usefull plugins thats you need.</div>
                            <div class="text">
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInLeft">
                            <video autoPlay loop muted playsInline><a href="" class="lightbox-image"><source src={about} type='video/mp4' /></a></video>
                        </div>
                    </div>
